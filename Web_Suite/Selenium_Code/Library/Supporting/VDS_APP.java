...
public class VDS_APP {
	
 public static void LaunchVDS_APP(String sTestName) throws NumberFormatException, InterruptedException, AWTException, HeadlessException, IOException{
	 WiniumDriver driverWinium =null;
	// IO.PrintLog(sTestName,"\n ---------------------------------------------------------------------------------------------------");
	 // Report.OperationPoint(sTestName, "LaunchVDS_APP()");
	 try{ 	 
